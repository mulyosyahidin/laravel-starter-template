...
@section('title', 'Toko ABC Bengkulu')

@include('includes.public.carousel')
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <!--Category & Title-->
                                <a href="{{ route('product') }}" class="grey-text">
                                    <h5>Shirt</h5>
                                </a>
                                <h5>
                                    <strong>
                                        <a href="{{ route('product') }}" class="dark-grey-text">Denim shirt
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5>
                                    <strong>
                                        <a href="{{ route('product') }}" class="dark-grey-text">Sweatshirt</a>
                                    </strong>
                                </h5>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5>
                                    <strong>
                                        <a href="{{ route('product') }}" class="dark-grey-text">Grey blouse
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5>
                                    <strong>
                                        <a href="{{ route('product') }}" class="dark-grey-text">Black jacket</a>
                                    </strong>
                                </h5>
